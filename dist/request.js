...
class Request extends events_1.EventEmitter {
  ...
  constructor(token, intents, queryString, offSetType, parseMode) {
    ...
    this.offset = 0;
    this.queryString =
      queryString !== null && queryString !== void 0
        ? queryString
        : "application/x-www-form-urlencoded";
    this.offSetType =
      offSetType !== null && offSetType !== void 0 ? offSetType : "time";
    ...
    if (typeof intents === "number") {
      this.intents = (0, IntentsBitField_1.decodeIntents)(
        new IntentsBitField_1.IntentsBitField(intents),
      );
    } else if (Array.isArray(intents) && intents.length > 0) {
      this.intents = intents;
    } else if (intents && typeof intents === "object") {
      this.intents = (0, IntentsBitField_1.decodeIntents)(
        new IntentsBitField_1.IntentsBitField(intents[0]),
      );
    } else {
      this.intents = null;
    }
  ...
  getUpdates() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (
        ...
        throw new errorcollection_1.TelegramTokenError(
