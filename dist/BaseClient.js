...
const errorcollection_js_1 = require("./errorcollection.js");
class BaseClient extends request_js_1.Request {
  ...
  getMe() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (!response) {
        throw new errorcollection_js_1.TelegramApiError(response);
      }
        ...
        media: {
          ...
          supports_streaming:
            (_h =
              options === null || options === void 0
                ? void 0
                : options.media) === null || _h === void 0
              ? void 0
              : _h.supportsStreaming,
        },
      };
      const response = yield this.request(method, params);
      if (
