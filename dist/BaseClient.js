    ...
    */
    ...
    deleteWebhook(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const params = {
                drop_pending_updates: options === null || options === void 0 ? void 0 : options.dropPendingUpdates,
            };
    ...
    setMyCommands(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const params = {
                ...
                scope: (options === null || options === void 0 ? void 0 : options.scope) || null,
                language_code: (options === null || options === void 0 ? void 0 : options.languageCode) || null,
            };
            const response = yield this.request(method, params);
            if (!!(response === null || response === void 0 ? void 0 : response.error_code)) {
                throw new errorcollection_js_1.TelegramApiError(response);
