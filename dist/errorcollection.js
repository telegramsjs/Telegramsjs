...
exports.ErrorExtension =
  exports.ErrorTable =
  exports.ParameterError =
  exports.BitFieldError =
  exports.IntentsError =
  exports.TelegramTokenError =
  exports.EventError =
  exports.TelegramApiError =
    void 0;
/**
...
class TelegramApiError extends Error {
  ...
  constructor(error) {
    ...
    if (error.error_code !== undefined) {
      message.description = (
        ((_d =
          (_c =
            (_b =
              (_a = error.description) === null || _a === void 0
                ? void 0
                : _a.replace("Bad Request: ", "")) === null || _b === void 0
              ? void 0
              : _b.replace("can't parse entities:", "")) === null ||
          _c === void 0
            ? void 0
            : _c.replace("Conflict: ", "")) === null || _d === void 0
          ? void 0
          : _d.replace("can't parse BotCommand: ", "")) || ""
      ).toLowerCase();
    ...
    this.name = `TelegramApiError[${
      (_e = error === null || error === void 0 ? void 0 : error.error_code) !==
        null && _e !== void 0
        ? _e
        : 0
    }]`;
    this.code =
      (_f = error === null || error === void 0 ? void 0 : error.error_code) !==
        null && _f !== void 0
        ? _f
        : 0;
