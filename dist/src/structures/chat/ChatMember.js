...
class ChatMember extends Base {
    ...
    permissionsIn(channel) {
        ...
        return ((_a = chat.members.resolve(this)) === null || _a === void 0 ? void 0 : _a.permissions) || null;
    }
    /**
    ...
    kick(options = {}) {
        if (!this.user) {
            throw new TelegramError("Could not find the user where this message came from in the cache!");
        }
