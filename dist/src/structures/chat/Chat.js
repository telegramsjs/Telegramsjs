...
class Chat extends Base {
    ...
    constructor(client, data) {
        ...
        if (!this.isPrivate()) {
             ...
             */
            this.members = new ChatMemberManager(client, this.id, (_a = client.options) === null || _a === void 0 ? void 0 : _a.memberCacheMaxSize);
        }
         ...
         * @type {MessageManager}
         */
        this.messages = new MessageManager(client, (_b = client.options) === null || _b === void 0 ? void 0 : _b.messageCacheMaxSize);
        this._patch(data);
    }
    _patch(data) {
        if ("title" in data) {
    ...
    memberPermissions(member, checkAdmin) {
        if ((member === null || member === void 0 ? void 0 : member.status) === null || this.isPrivate()) {
            return null;
        }
        if (checkAdmin && (member === null || member === void 0 ? void 0 : member.status) === "creator") {
