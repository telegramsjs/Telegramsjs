...
class Poll extends Base {
    ...
    _patch(data) {
        if ("question_entities" in data) {
             ...
             */
            this.questionEntities = new MessageEntities(this.question, data.question_entities);
        }
        if ("options" in data) {
            const options = [];
        ...
        if ("explanation" in data) {
            ...
            if ("explanation_entities" in data) {
                 ...
                 * @type {MessageEntities | undefined}
                 */
                this.explanationEntities = new MessageEntities(data.explanation, data.explanation_entities);
            }
        }
