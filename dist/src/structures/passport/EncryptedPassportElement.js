...
class EncryptedPassportElement extends Base {
    ...
    _patch(data) {
        ...
        if ("files" in data) {
             ...
             */
            this.files = data.files.map((file) => new PassportFile(this.client, file));
        }
        ...
        if ("translation" in data) {
             ...
             * @type {PassportFile[] | undefined}
             */
            this.translation = data.translation.map((translated) => new PassportFile(this.client, translated));
        }
        return data;
    }
}
module.exports = { EncryptedPassportElement };
//# sourceMappingURL=EncryptedPassportElement.js.map