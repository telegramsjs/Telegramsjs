...
import type { InlineQueryResult, InlineQueryResultsButton, LabeledPrice, ShippingOption } from "./Inline";
import type { MessageEntity, LinkPreviewOptions, MaskPosition, InputPollOption, ReplyParameters, ReactionType } from "./Message";
import type { InlineKeyboardMarkup, ForceReply, ReplyKeyboardMarkup, ReplyKeyboardRemove } from "./Markup";
...
export type ApiMethods = {
    ...
    setWebhook(args: {
        ...
        certificate?: Buffer | ReadStream | Blob | FormData | DataView | ArrayBuffer | Uint8Array | string;
    ...
    sendPhoto(args: {
        ...
        photo: Buffer | ReadStream | Blob | FormData | DataView | ArrayBuffer | Uint8Array | string;
    ...
    sendAudio(args: {
        ...
        audio: Buffer | ReadStream | Blob | FormData | DataView | ArrayBuffer | Uint8Array | string;
        ...
        thumbnail?: Buffer | ReadStream | Blob | FormData | DataView | ArrayBuffer | Uint8Array | string;
        /** Sends the message silently. Users will receive a notification with no sound. */
        disableNotification?: boolean;
        /** Protects the contents of the sent message from forwarding and saving */
        protectContent?: boolean;
    ...
    sendDocument(args: {
        ...
        document: Buffer | ReadStream | Blob | FormData | DataView | ArrayBuffer | Uint8Array | string;
        /** Thumbnail of the file sent; can be ignored if thumbnail generation for the file is supported server-side. The thumbnail should be in JPEG format and less than 200 kB in size. A thumbnail's width and height should not exceed 320. Ignored if the file is not uploaded using multipart/form-data. Thumbnails can't be reused and can be only uploaded as a new file, so you can pass "attach://<file_attach_name>" if the thumbnail was uploaded using multipart/form-data under <file_attach_name>. */
        thumbnail?: Buffer | ReadStream | Blob | FormData | DataView | ArrayBuffer | Uint8Array | string;
    ...
    sendVideo(args: {
        ...
        video: Buffer | ReadStream | Blob | FormData | DataView | ArrayBuffer | Uint8Array | string;
    ...
    sendAnimation(args: {
        ...
        animation: Buffer | ReadStream | Blob | FormData | DataView | ArrayBuffer | Uint8Array | string;
    ...
    sendVoice(args: {
        ...
        voice: Buffer | ReadStream | Blob | FormData | DataView | ArrayBuffer | Uint8Array | string;
    ...
    sendVideoNote(args: {
        ...
        videoNote: Buffer | ReadStream | Blob | FormData | DataView | ArrayBuffer | Uint8Array | string;
        /** Duration of sent video in seconds */
        duration?: number;
    ...
    sendMediaGroup(args: {
        ...
        /** Description of the message to reply to */
        replyParameters?: ReplyParameters;
    }): Array<(import("../../structures/message/Message").Message & {
        audio: import("../../structures/media/Audio").Audio;
    }) | (import("../../structures/message/Message").Message & {
        document: import("../../structures/media/Document").Document;
    }) | (import("../../structures/message/Message").Message & {
    ...
    getChatAdministrators(args: {
        /** Unique identifier for the target chat or username of the target supergroup or channel (in the format @channelusername) */
        chatId: number | string;
    }): Array<import("../../structures/chat/ChatAdministratorRights").ChatAdministratorRights>;
    ...
    sendSticker(args: {
        ...
        sticker: Buffer | ReadStream | Blob | FormData | DataView | ArrayBuffer | Uint8Array | string;
...
export interface InputMediaPhoto {
    ...
    media: Buffer | ReadStream | Blob | FormData | DataView | ArrayBuffer | Uint8Array | string;
