            ...
            for (const [type, options] of Object.entries(messageTypeMap)) {
              ...
              if (updateProperty) {
                ...
                const message = Object.assign(
                  Object.assign({}, updateProperty),
                  {
                    chat,
                    client: this,
                    reply: (args, defaults) => this.reply(args, defaults),
                    isCommand: args => this.isCommand(args),
                  },
                );
  ...
  reply(options, defaults) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (typeof options === "object" && typeof defaults === "object") {
        ...
        (defaults === null || defaults === void 0 ? void 0 : defaults.text)
      ) {
        throw new errorcollection_1.ParameterError(
      ...
      if (
        (_b =
          (_a = this.updates) === null || _a === void 0
            ? void 0
            : _a.callback_query) === null || _b === void 0
          ? void 0
          : _b.message
      ) {
        chatId =
          ...
          (defaults === null || defaults === void 0
            ...
            : defaults.chatId) ||
          ((_d =
            (_c = this.updates.callback_query) === null || _c === void 0
              ? void 0
        ...
        messageId =
          ...
          (defaults === null || defaults === void 0
            ...
            : defaults.messageId) ||
          ((_f =
            (_e = this.updates.callback_query) === null || _e === void 0
              ? void 0
              : _e.message) === null || _f === void 0
            ? void 0
            : _f.message_id);
      } else if (
        (_g = this.updates) === null || _g === void 0
          ? void 0
          : _g.edited_message
      ) {
        chatId =
          ...
          (defaults === null || defaults === void 0
            ...
            : defaults.chatId) ||
          ((_j =
            (_h = this.updates.edited_message) === null || _h === void 0
              ? void 0
              : _h.chat) === null || _j === void 0
            ? void 0
            : _j.id);
        messageId =
          (options === null || options === void 0
          ...
          (defaults === null || defaults === void 0
            ? void 0
            : defaults.messageId) ||
          ((_k = this.updates.edited_message) === null || _k === void 0
            ? void 0
            : _k.message_id);
      } else if (
        (_l = this.updates) === null || _l === void 0
          ? void 0
          : _l.edited_channel_post
      ) {
        chatId =
          (options === null || options === void 0 ? void 0 : options.chatId) ||
          (defaults === null || defaults === void 0
        ...
        messageId =
          ...
          (defaults === null || defaults === void 0
            ? void 0
            : defaults.messageId) ||
          ((_p = this.updates.edited_channel_post) === null || _p === void 0
            ? void 0
            : _p.message_id);
      } else {
        chatId =
          ...
          (defaults === null || defaults === void 0
            ...
            : defaults.chatId) ||
          ((_r =
            (_q = this.updates) === null || _q === void 0
              ? void 0
              : _q.chat) === null || _r === void 0
            ? void 0
            : _r.id) ||
          ((_u =
            (_t =
              (_s = this.updates) === null || _s === void 0
                ? void 0
                : _s.channel_post) === null || _t === void 0
              ? void 0
              : _t.chat) === null || _u === void 0
            ? void 0
            : _u.id);
        messageId =
          (options === null || options === void 0
          ...
          (defaults === null || defaults === void 0
            ? void 0
            : defaults.messageId) ||
          ((_v = this.updates) === null || _v === void 0
            ? void 0
            : _v.message_id) ||
          ((_x =
            (_w = this.updates) === null || _w === void 0
              ? void 0
              : _w.channel_post) === null || _x === void 0
            ? void 0
            : _x.message_id);
      }
      if (text === undefined) {
      ...
      return this.functions.sendMessage({
        ...
        chatId: chatId,
        replyMarkup:
          (_y = options.replyMarkup) !== null && _y !== void 0
            ? _y
            : defaults === null || defaults === void 0
            ? void 0
            : defaults.replyMarkup,
        allowReply:
          (_z = options.allowReply) !== null && _z !== void 0
            ? _z
            : defaults === null || defaults === void 0
            ? void 0
            : defaults.allowReply,
        ...
        notification:
          (_0 = options.notification) !== null && _0 !== void 0
            ? _0
            : defaults === null || defaults === void 0
            ? void 0
            : defaults.notification,
        content:
          (_1 = options.content) !== null && _1 !== void 0
            ? _1
            : defaults === null || defaults === void 0
            ? void 0
            : defaults.content,
        threadId:
          (_2 = options.threadId) !== null && _2 !== void 0
            ? _2
            : defaults === null || defaults === void 0
            ? void 0
            : defaults.threadId,
        parseMode:
          (_3 = options.parseMode) !== null && _3 !== void 0
            ? _3
            : defaults === null || defaults === void 0
            ? void 0
            : defaults.parseMode,
  ...
  send(options, defaults) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (
        ...
        (_e = this.updates) === null || _e === void 0 ? void 0 : _e.chat
      ) {
        chatId =
          (options === null || options === void 0 ? void 0 : options.chatId) ||
          (defaults === null || defaults === void 0
            ? void 0
            : defaults.chatId) ||
          ((_f = this.updates.chat) === null || _f === void 0 ? void 0 : _f.id);
      } else {
      ...
      return this.functions.sendMessage({
        ...
        replyMarkup:
          (_g =
            options === null || options === void 0
              ? void 0
              : options.replyMarkup) !== null && _g !== void 0
            ? _g
            : defaults === null || defaults === void 0
            ? void 0
            : defaults.replyMarkup,
        allowReply:
          (_h =
            options === null || options === void 0
              ? void 0
              : options.allowReply) !== null && _h !== void 0
            ? _h
            : defaults === null || defaults === void 0
            ? void 0
            : defaults.allowReply,
        notification:
          (_j =
            options === null || options === void 0
              ? void 0
              : options.notification) !== null && _j !== void 0
            ? _j
            : defaults === null || defaults === void 0
            ? void 0
            : defaults.notification,
        content:
          (_k =
            options === null || options === void 0
              ? void 0
              : options.content) !== null && _k !== void 0
            ? _k
            : defaults === null || defaults === void 0
            ? void 0
            : defaults.content,
        threadId:
          (_l =
            options === null || options === void 0
              ? void 0
              : options.threadId) !== null && _l !== void 0
            ? _l
            : defaults === null || defaults === void 0
            ? void 0
            : defaults.threadId,
        parseMode:
          (_m =
            options === null || options === void 0
              ? void 0
              : options.parseMode) !== null && _m !== void 0
            ? _m
            : defaults === null || defaults === void 0
            ? void 0
            : defaults.parseMode,
      ...
      if (
        ...
        chat_id =
          (_e =
            (_d =
              (_c =
                (_b = this.updates) === null || _b === void 0
                  ? void 0
                  : _b.callback_query) === null || _c === void 0
                ? void 0
                : _c.message) === null || _d === void 0
              ? void 0
              : _d.chat) === null || _e === void 0
            ? void 0
            : _e.id;
      } else {
        chat_id =
          (_g =
            (_f = this.updates) === null || _f === void 0
              ? void 0
              : _f.chat) === null || _g === void 0
            ? void 0
            : _g.id;
      }
  ...
  isCommand(checkAllEntities) {
    ...
    const allEntities = [
      (_a = this.updates.message) === null || _a === void 0
        ? void 0
        : _a.entities,
      (_b = this.updates.edited_message) === null || _b === void 0
        ? void 0
        : _b.entities,
      (_c = this.updates.pinned_message) === null || _c === void 0
        ? void 0
        : _c.entities,
      (_d = this.updates.channel_post) === null || _d === void 0
        ? void 0
        : _d.entities,
      (_f =
        (_e = this.updates.channel_post) === null || _e === void 0
          ? void 0
          : _e.pinned_message) === null || _f === void 0
        ? void 0
        : _f.entities,
      (_g = this.updates.pinned_message) === null || _g === void 0
        ? void 0
        : _g.entities,
