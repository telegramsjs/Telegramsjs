...
const BOT_TOKEN = '6109256381:AAEwL7wENwTIf41pJuwSwfsjl7HGLtKgG-4'
if (!BOT_TOKEN) {
...
api.setMessageProvider(new TG.WebhookMessageProvider({
    privateKey: undefined, //path.join(__dirname, './private.key'),
    publicKey: undefined, //path.join(__dirname, './public.key'),
    host: IP,
    port: 8443
}))
api.start()
