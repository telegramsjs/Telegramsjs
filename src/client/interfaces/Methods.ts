...
export type ApiMethods = {
  ...
  getMe(): import("../../structures/misc/client/ClientUser").ClientUser;
  ...
  sendChecklist(args: {
    ...
    checklist: import("../../structures/checklist/Checklist").Checklist;
  };
  ...
  getUserProfilePhotos(args: {
    ...
    limit?: number;
  }): import("../../structures/misc/user/UserProfilePhotos").UserProfilePhotos;
  ...
  getUserProfileAudios(args: {
    ...
    limit?: number;
  }): import("../../structures/misc/user/UserProfileAudios").UserProfileAudios;
  ...
  restrictChatMember(args: {
    ...
    permissions: import("../../util/permission/ChatPermissions").ChatPermissionFlags;
  ...
  getManagedBotAccessSettings(args: {
    ...
    userId: number | string;
  }): import("../../structures/misc/client/BotAccessSettings").BotAccessSettings;
  ...
  getUserGifts(args: {
    ...
    limit?: number;
  }): import("../../structures/gift/OwnedGifts").OwnedGifts;
  ...
  setMyDefaultAdministratorRights(args: {
    ...
    rights?: import("../../util/permission/ChatPermissions").ChatPermissionFlags;
  ...
  getBusinessAccountStarBalance(args: {
    /** Unique identifier of the business connection */
    businessConnectionId: string;
  }): import("../../structures/misc/StarAmount").StarAmount;
  ...
  getMyStarBalance(): import("../../structures/misc/StarAmount").StarAmount;
  ...
  postStory(args: {
    ...
    protectContent?: boolean;
  }): import("../../structures/story/Story").Story;
  ...
  getStarTransactions(args: {
    ...
    limit?: number;
  }): import("../../structures/invoice/StarTransactions").StarTransactions;
